...
(function() {
    ...
    var cesiumBase = 'http://cesiumjs.org/releases/1.6/';

    require.config({
        baseUrl : '../Source',
        paths : {
            'CesiumSensors' : '../Source',

            'Cesium' : cesiumBase + 'Source',
        ...
        map : {
            '*' : {
                ...
                'Core' : 'Cesium/Core',
                'DataSources' : 'Cesium/DataSources',
                'Renderer' : 'Cesium/Renderer',
                'Scene' : 'Cesium/Scene',
                'Shaders' : 'Cesium/Shaders',
                'ThirdParty' : 'Cesium/ThirdParty',
    ...
    function requireTests() {
        ...
        require(modules, function(addDefaultMatchers, equalsMethodEqualityTester) {
            ...
            env.beforeEach(addDefaultMatchers(false));
